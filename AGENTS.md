...
An open-source, local-first, model-agnostic AI workspace for macOS, Windows,
and Linux that unifies three pillars: **AI cowork** (agents, office documents,
automation), **design** (templates, prototypes, exports), and **science**
(research sessions, notebooks, provenance). See `README.md` and `docs/PRD.md`.
