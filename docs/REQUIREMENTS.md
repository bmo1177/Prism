# Craft — Prioritized Requirements (Community-Informed)

> **Purpose.** This document turns real community evidence into concrete,
> prioritized requirements for **Craft**, our open-source, local-first,
...
Craft must win on those four axes — plus two things competitors are
...
Market as: *"Craft — local-first, model-agnostic AI research
